    ...
    bool NavFn::propAstar(int cycles)
    {
        ...
        */
        ...
        for(; cycle < cycles; cycle++)
        {
            ...
            */
            for (int i = 0; i < n_curPotentArr_; i++) {
        ...
        if (costarr_[n] < COST_OBS) // Only update and propagate the cell without obstacle
        {
            ...
            */           
            ...
            /* TODO TASK - MILESTONE # 3.2
                ...
                sqrt(2) grid unit. 
            */
            tl = potarr_[n - nx_ - 1] + costarr_[n]*SQUAREROOT2;
            tr = potarr_[n - nx_ + 1] + costarr_[n]*SQUAREROOT2;
            bl = potarr_[n + nx_ - 1] + costarr_[n]*SQUAREROOT2;
            br = potarr_[n + nx_ + 1] + costarr_[n]*SQUAREROOT2;
                ...
                if (pot < potentThresh_)
                {
                    ...
                    */
                    ...
                    if (potarr_[n - nx_] > pot + costarr_[n - nx_]) {
                        potarr_[n - nx_] = pot + costarr_[n - nx_];
                        push_next(n - nx_);
                    }
                    ...
                    */
                    if (potarr_[n - nx_ - 1] > pot +  sqrt(2) * costarr_[n - nx_ - 1]) {
                        potarr_[n - nx_ - 1] = pot +  sqrt(2) * costarr_[n - nx_ - 1];
                        push_next(n - nx_ - 1);
                    }
